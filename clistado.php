...
<table class="table">
	...
	if(mysql_num_rows($result_set)>0)
	{
		...
		?>
            ...
            <td align="center"><a href="javascript:edt_id('<?php echo $row[0]; ?>')"><img src="img/editar.jpg" align="EDIT" /></a></td>
            <td align="center"><a href="javascript:delete_id('<?php echo $row[0]; ?>')"><img src="img/eliminar.jpg" align="DELETE" /></a></td>
            </tr>
        <?php
		}
	}
